...
class _SearchPageState extends State<SearchPage> {
  ...
  createCategoryList() {
    ...
    listCategory.add('BREAD/BAKERY');
    listCategory.add('CANNED/JARRED GOODS');
    listCategory.add('DAIRY');
    listCategory.add('DRY/BAKING GOODS');
    listCategory.add('FROZEN FOODS');
    listCategory.add('MEAT');
    listCategory.add('PRODUCE');
    listCategory.add('CLEANERS');
    listCategory.add('PAPER GOODS');
          ...
          Expanded(
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                    image: AssetImage("images/product_1.png"),
                    fit: BoxFit.cover),
              ),
            ),
            flex: 70,
