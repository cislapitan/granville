        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              createAddressText("27, North Golden Bridge", 16),
              createAddressText("Baguio City - 2600", 6),
              createAddressText("Benguet", 6),
              SizedBox(
                height: 6,
              ),
              RichText(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              createPriceItem("Order Total", getFormattedCurrency(2013),
                  Colors.grey.shade700),
              createPriceItem(
                  "Delivery Charges", "PHP 50.00", Colors.teal.shade300),
              SizedBox(
                height: 8,
              ),
              Container(
